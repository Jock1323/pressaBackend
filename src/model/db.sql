...
CREATE TYPE category_type AS ENUM ('it','dizayn','biznes','ta''lim');
CREATE TYPE subcategory_type AS ENUM('web dasturlash','mobile dasturlash','ui/ux dizayn','grafik dizayn','menejment','kredit va audit','matematika','fizika');
...
INSERT INTO categories(category_title)values('it'),('dizayn'),('biznes'),('ta''lim');
INSERT INTO subcategories(subcategory_title,category_id)values('web dasturlash',1),('mobile dasturlash',1),('ui/ux dizayn',2),('grafik dizayn',2),('menejment',3),('kredit va audit',3),('matematika',4),('fizika',4);
INSERT INTO users(fullname,user_profession,user_type,user_company)values('mirsidiq mirzokirov','web dasturchi','jismoniy shaxs',''),('suhrob izzatillayev','biznesman','yuridik shaxs','suhrob industries');
INSERT INTO users(fullname,user_profession,user_type)values('asliddin umaraliyev','web dasturchi','jismoniy shaxs');

INSERT INTO join_categories(
  category_id,
  subcategory_id
)
...
insert into Meeting(meet_title,meet_description,meet_text,meet_date,meet_time,meet_status,meet_link_youtube,meet_image,subcategory_id,user_id)values('dasturlash','web dasturlash','nimadirasdas','2022-12-15','13:00','online','ADSAFGHJG','jock',1,1);
insert into Meeting(meet_title,meet_description,meet_text,meet_date,meet_time,meet_status,meet_link_youtube,meet_image,subcategory_id,user_id)values('ta''lim','fan','nimadirasdas','2022-12-15','13:00','offline','ADSAFGHJG','luck',7,2);
...
('adsdf','dasfad','adasdasd','adasdasdda','asliddin','2012-12-26','online','jismoniy','dasdadadasdasdadas'),
('adsdf','dasfad','adasdasd','adasdasdda','suhrob','2010-12-26','offline','yuridik','dasdadadasdasdadas');
